...
import com.revampes.Fault.modules.impl.dungeon.PuzzleSolver.TicTacToeSolver;
import com.revampes.Fault.modules.impl.dungeon.PuzzleSolver.TeleportMazeSolver;
import com.revampes.Fault.modules.impl.dungeon.PuzzleSolver.ThreeWeirdosSolver;
import com.revampes.Fault.modules.impl.dungeon.PuzzleSolver.TriviaSolver;
import com.revampes.Fault.modules.impl.dungeon.PuzzleSolver.WaterBoardSolver;
...
//    public static Freecam freecam;
    ...
    public static TicTacToeSolver ticTacToeSolver;
    public static TeleportMazeSolver teleportMazeSolver;
    public static ThreeWeirdosSolver threeWeirdosSolver;
    public static TriviaSolver triviaSolver;
    public static WaterBoardSolver waterBoardSolver;
...
//        this.addModule(freecam = new Freecam());
        ...
        this.addModule(ticTacToeSolver = new TicTacToeSolver());
        this.addModule(teleportMazeSolver = new TeleportMazeSolver());
        this.addModule(threeWeirdosSolver = new ThreeWeirdosSolver());
        this.addModule(triviaSolver = new TriviaSolver());
        this.addModule(waterBoardSolver = new WaterBoardSolver());
