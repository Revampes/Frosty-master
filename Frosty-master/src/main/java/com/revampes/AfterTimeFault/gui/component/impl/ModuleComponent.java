package com.revampes.AfterTimeFault.gui.component.impl;
...
import com.revampes.AfterTimeFault.gui.component.Component;
import com.revampes.AfterTimeFault.modules.ModuleManager;
import com.revampes.AfterTimeFault.modules.impl.client.UI;
...
public class ModuleComponent extends Component {
    ...
    public ModuleComponent(Module module, float x, float y, float width, float height) {
        ...
        for (Setting setting : module.getSettings()) {
            if (setting instanceof com.revampes.AfterTimeFault.settings.impl.KeyBindSetting) {
                settingComponents.add(new KeyBindComponent((com.revampes.AfterTimeFault.settings.impl.KeyBindSetting) setting,
                        x + 5, settingY, width - 10, height - 5));
                settingY += height - 5 + 2;
            } else if (setting instanceof com.revampes.AfterTimeFault.settings.impl.ButtonSetting) {
                settingComponents.add(new ButtonComponent((com.revampes.AfterTimeFault.settings.impl.ButtonSetting) setting,
                        x + 5, settingY, width - 10, height - 5));
                settingY += height - 5 + 2;
            } else if (setting instanceof com.revampes.AfterTimeFault.settings.impl.SliderSetting) {
                settingComponents.add(new SliderComponent((com.revampes.AfterTimeFault.settings.impl.SliderSetting) setting,
                        x + 5, settingY, width - 10, height - 5));
                settingY += height - 5 + 2;
            } else if (setting instanceof com.revampes.AfterTimeFault.settings.impl.SelectSetting) {
                settingComponents.add(new SelectComponent((com.revampes.AfterTimeFault.settings.impl.SelectSetting) setting,
                        x + 5, settingY, width - 10, height - 5));
                settingY += height - 5 + 2;
            } else if (setting instanceof com.revampes.AfterTimeFault.settings.impl.InputSetting) {
                settingComponents.add(new InputComponent((com.revampes.AfterTimeFault.settings.impl.InputSetting) setting,
                        x + 5, settingY, width - 10, height - 5));
                settingY += height - 5 + 2;
            }
        }
